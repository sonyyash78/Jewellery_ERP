...
export default function BillTable() {
  ...
  const columns = [
    ...
    columnHelper.accessor('grossWeight', { header: 'Gross Wt', cell: i => <span className="font-mono">{(i.getValue() || 0).toFixed(3)}</span> }),
    columnHelper.accessor('stoneWeight', { header: 'Stone Wt', cell: i => <span className="font-mono">{(i.getValue() || 0).toFixed(3)}</span> }),
    columnHelper.accessor('netWeight', { header: 'Net Wt', cell: i => <span className="font-mono font-bold text-primary">{(i.getValue() || 0).toFixed(3)}</span> }),
    columnHelper.accessor('rateDisplay', { header: 'Rate', cell: i => <span className="font-mono">{(i.getValue() || 0).toLocaleString()}</span> }),
    columnHelper.accessor('makingAmount', { header: 'Making', cell: i => <span className="font-mono">{(i.getValue() || 0).toFixed(2)}</span> }),
    columnHelper.accessor('taxableAmount', { header: 'Amount', cell: i => <span className="font-mono">{(i.getValue() || 0).toFixed(2)}</span> }),
